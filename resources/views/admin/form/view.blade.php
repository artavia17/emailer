        ...
        <div class="card-body">
          ...
          <div class="d-flex align-items-start">
            <div class="nav flex-column nav-pills me-3 w-100" id="" style="" aria-orientation="vertical">
              ...
              <a href="{{route('form_indivudual', $value->id)}}" style="border-radius: 0px !important;" class="nav-link d-flex justify-content-between border-bottom" id="v-pills-profile-tab">
                {{$value->name}}
